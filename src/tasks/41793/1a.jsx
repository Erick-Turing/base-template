...
export default function App() {
  ...
  useEffect(() => {
    const handleResize = () => {
      // Force re-render on window resize to ensure proper grid sizing
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <div>
              <label htmlFor="x-slider" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div>
              <label htmlFor="y-slider" className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div className="w-full max-w-full aspect-[16/9] mx-auto">
